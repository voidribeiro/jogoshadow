...
void SkeletalModel::setAnimType(CSK_ANIM setAnimType) {
...
CSK_ANIM SkeletalModel::getAnimType() const {
	return animType;
}

// animates the skeleton
void SkeletalModel::animSkeleton(core::position2di mousePos) {
...
scene::IAnimatedMeshSceneNode *SkeletalModel::getSkeletonSceneNode() {
	return skeletonNode;
}

// returns motion variable
u32 SkeletalModel::getMotionVariable() {
	return k;
}

// return the second motion variable
u32 SkeletalModel::getSecondMotionVariable() {
	return kTemp;
}

void SkeletalModel::animWalk() {
...
void SkeletalModel::animBackward() {
...
void SkeletalModel::animStrafeLeft() {
...
void SkeletalModel::animStrafeRight() {
...
void SkeletalModel::animHead(core::position2di mousePos) {
...
void SkeletalModel::animInterpolation() {
...
core::vector3df SkeletalModel::getSkeletonVelocity() const {
